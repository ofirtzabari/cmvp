              ...
              <div className="w-full 800px:w-[50%] pt-5 pl-[5px] pr-[5px]">
                ...
                <div className="flex items-center mt-12 justify-between pr-3">
                  <div>
                    ...
                    <span className="bg-gradient-to-r from-teal-400 to-teal-500 text-white font-bold rounded-l px-4 py-2 shadow-lg hover:opacity-75 transition duration-300 ease-in-out">
                      {count}
                    </span>
                    <button
                ...
                <div className={`${styles.button} mt-6 rounded flex items-center h-11`}>
                    <span className="text-white flex items-center">
